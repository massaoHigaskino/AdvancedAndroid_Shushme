...
public class MainActivity extends AppCompatActivity
    ...
    public void onConnected(@Nullable Bundle bundle) {
        Log.d(TAG, "onConnected: succesful");
    }
    ...
    protected void onResume() {
        super.onResume();
        CheckBox permissionCheckbox = (CheckBox) findViewById(R.id.permission_checkbox);
    ...
    public void onAddPlaceClicked(View view) {
        String status = ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION)
                != PackageManager.PERMISSION_GRANTED ? "DENIED" : "GRANTED";
        Log.d(TAG, "ACCESS_FINE_LOCATION permission status: " + status);
    }
