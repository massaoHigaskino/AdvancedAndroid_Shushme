...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGeofencingEnabled = getPreferences(MODE_PRIVATE).getBoolean("enableGeofences", false);
        ...
        getPreferences(MODE_PRIVATE).registerOnSharedPreferenceChangeListener(
            ...
            public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
                if(key.equals("enableGeofences")) {
                    mGeofencingEnabled = sharedPreferences.getBoolean(key, false);
